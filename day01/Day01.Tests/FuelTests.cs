...
namespace Day01.Tests
{
    ...
    public class FuelTests
    {
        ...
        public void CalculateFuelWeight(int weight, int expectedResult)
        {
            ...
            var fuelWeight = Fuel.CalculateFuelRecursively(weight);
            Assert.AreEqual(expectedResult, fuelWeight);
